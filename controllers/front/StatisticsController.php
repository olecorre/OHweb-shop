...
class StatisticsControllerCore extends FrontController
{
    ...
    // Prevent error 500 during statistics collections
    // Smarty exception: 0():Missing '$template' parameter
    // Alternatively, prevents the statistics controller to
    // initiate the display hook chain
    public function run()
    {
