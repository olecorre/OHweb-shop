...
class AdminCustomersControllerCore extends AdminController
{
    ...
    public function renderView()
    {
        ...
        for ($i = 0; $i < $total_carts; $i++) {
            ...
            $summary = $cart->getOrderTotal(true, Cart::ONLY_PRODUCTS); // Avoid carrier chain at this stage
            ...
            $carts[$i]['total_price'] = Tools::displayPrice($summary, $currency);
        ...
        $referrers = array_slice($referrers,0,50);
