		...
		<div class="col-lg-7">
			<div class="panel">
				<div class="panel-heading">
					...
					<span class="badge"><a href="{$link->getAdminLink('AdminCarts')|escape:'html':'UTF-8'}&amp;viewcart&amp;id_cart={$order->id_cart|intval}"><i class="icon-shopping-cart"></i>&nbsp;{$order->id_cart}</a></span>
