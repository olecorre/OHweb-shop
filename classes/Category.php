...
class CategoryCore extends ObjectModel
{
    ...
    public function getSubCategories($id_lang, $active = true)
    {
        ...
        if (Group::isFeatureActive()) {
            ...
            $sql_groups_where = 'AND cg.`id_group` IN ('.implode(',', $groups).')';
        }
        ...
        foreach ($result as &$row) {
	    if (Tools::file_exists_cache(_PS_CAT_IMG_DIR_.$row['id_category'].'.jpg')||Tools::file_exists_cache(_PS_CAT_IMG_DIR_.$row['id_category'].'_thumb.jpg')) {
