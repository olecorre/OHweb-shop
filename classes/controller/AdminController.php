...
class AdminControllerCore extends Controller
{
    ...
    public function renderModulesList()
    {
        ...
        if (!empty($this->filter_modules_list) && $this->getModulesList($this->filter_modules_list)) {
            $tmp = array();
    ...
    )
    {
        ...
        do {
            ...
            ($this->_tmpTableFilter ? ' LIMIT 18446744073709551615) tmpTable WHERE 1'.$this->_tmpTableFilter : '');
    ...
    public function getModulesList($filter_modules_list)
    {
        ...
        if (!is_countable($filter_modules_list) || !count($filter_modules_list)) {
            return false;
